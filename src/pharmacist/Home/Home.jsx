...
/**
 * @function Home
 * @returns Home page for the pharmacists
 */
    ...
    */
    const Column = [
          ...
          },
        {
            ...
            renderCell  : (params)=> {                                   
                return(
                    <>
                    {/** @description this button takes the user to a page where he can view and give prescription of a particular visit */}
    ...
    return (
        <div className="lab_home">
            ...
            <div className="table">
                {/** @description the Datagrid displays the visit pending assignment of prescription */}
                 <DataGrid
