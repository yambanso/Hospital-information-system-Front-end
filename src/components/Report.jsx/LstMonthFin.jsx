...
/**
 * @function LstMonthFin
 * @returns last months financial report
 */
export default function LstMonthFin() {
  ...
  const fetchData = async() => {
        ...
        await getMonthlyPrescribed.get("/lastMonth").then(res =>{
            setPrescr(res.data)
        })

        await getMonthlyUnprescribed.get("/lastMonth").then(res => {
  ...
  return (
        ...
        <div className="bar">
            <div className="Ttle">
                <span className="hdr">Last Month's Financial Report</span>
                </div>
