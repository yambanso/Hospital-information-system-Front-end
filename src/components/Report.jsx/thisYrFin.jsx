...
/**
 * @function ThisYrFin
 * @returns current years financial report
 */

export default function ThisYrFin() {
    ...
    */
    const fetchData = async() => {
        let T = 0
        await getReport.get("/thisYear").then(res => {
            let vis = res.data;
            setVisits(res.data)
            vis.map((item) => {                
        ...
        await getMonthlyPrescribed.get("/thisYear").then(res =>{
            setPrescr(res.data)
        })

        await getMonthlyUnprescribed.get("/thisYear").then(res => {
  ...
  return (
        ...
        <div className="bar">
            <div className="Ttle">
                <span className="hdr">This Years Financial Report</span>
                </div>
            ...
            <div className="overView">
                ...
                <div className="mdetails">
                    <div className="mTotal">
                        <span className="head">The lab tests conducted this year are  </span>
