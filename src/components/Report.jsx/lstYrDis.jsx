...
/**
 * @function LstYrDis
 * @returns Last years Diseases diagnosis report
 */

export default function LstYrDis() {
  ...
  */
  const fetchData = async() => {
    await getDiagnosis.get("/lastYear").then(res =>{
          let v = res.data
  ...
  return (
    <div>
      <div className="bar">
    <div className="Ttle">
        <span className="hdr">Last Year's Diagnosis Report</span>
        </div>        
    </div>
    ...
    <div className="overView">
                ...
                <div className="TableTitle">
                    <span className="TableTitleText">Last Year's Cases</span>
                </div>
                <div className="tble">
                    {/**
